...
public class GroupDetailActivity extends BaseActivity {
    ...
    private TextView numOfMemberTxt;
    private TextView hostMessageTxt;
    private LinearLayout pageControllerLayout;
    private TextView dateAndTimeTxt;
    private TextView locationTxt;
    private ImageView checkAllMemberImageView;
    private FrameLayout googleMapLayout;
